...
const devs = ["345266048922157056", "380307890235506698"]
...
var guilds = {};
var x = client.channels.get("576209706931191808");

/////////////////////////////////////////////////////////////////
client.on("ready", () => {
client.user.setStatus('dnd');
  console.log("Reeebel | Logged in! Server count: ${client.guilds.size}");
  client.user.setActivity("Ramadan 🌙",{type: 'LISTENING'});
});
/////////////////////////////////////////////////////////////////////////////////
/////////////////////////////////////////////////////////////////////////////////
...
client.on('message', async function(message) {
    ...
    if (message.content.startsWith(`${prefix}eval`)) {
      ...
      if(message.content.startsWith(`${prefix}info`)) {
        ...
        .addField("Creator", "**Óff,#1981**", true)
